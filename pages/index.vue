<template>
    <section :class="['navigation', { 'navigation--active': showNav }]">
      <slider />
    </section>
    <iframe style="width:100vw;height:100vh;border:0px;" allow="autoplay;" src="https://cables.gl/view/tduqhJ"></iframe>
